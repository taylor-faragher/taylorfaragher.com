...
const Resume = () => {
    return (
        <section id="resume" className="md:pb-0">
            <div className="flex justify-center text-center min-w-full shrink-0 gap-16 py-4 flex-nowrap h-[45vh] md:h-[37vh] lg:h-[45vh] w-auto">
                    
                <div className="w-[100vw] h-auto max-w-full sm:max-w-[85%] md:max-w-[80%] relative rounded-2xl border flex-shrink-0 border-slate-800 md:w-[70vw] overflow-hidden" data-test-id="testId">
