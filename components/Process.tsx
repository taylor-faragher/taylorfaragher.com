...
import { CanvasRevealEffect } from "@/components/ui/RevealBox";
    ...
    <section className="w-full pt-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card 
            ...
            description="Something here as well"
            >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development and Launch" icon={<AceternityIcon order='Phase3' />}
        description="Need a description for this one too">
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="dark:text-white text-xl opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center" style={{color:'#e4ecff'}}>
          {description}
        </h2>
      </div>
    </div>
